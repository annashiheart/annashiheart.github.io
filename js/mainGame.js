...
const gameData = {
    "1": {
        ...
        "image": "canada_images/alarm_clock.png",
        "choices": {
    ...
    "2": {
        "text": "You arrive at work. Your coworker starts speaking only in French. How do you respond?",
        "image": "canada_images/french_conversation.png",
        "choices": {
        ...
        "Challenge them to a bilingual pun-off": [3, ["Quebec"]],
    ...
    "3": {
        ...
        "image": "canada_images/lunch.png",
        "choices": {
        "A steaming pile of poutine with extra curds": [4, ["Quebec", "Ontario"]],
        "A butter tart and a Nanaimo bar, because why not both": [4, ["Manitoba", "British Columbia"]],
        "Maple-glazed salmon caught fresh this morning": [4, ["Yukon", "Newfoundland"]],
        "Ketchup chips and a bagged milk to wash it down": [4, ["Saskatchewan", "Prince Edward Island"]]
        }
    },
    "4": {
        "text": "After work, you're headed to the bar to watch the NHL Finals. What are you bringing?",
        "image": "canada_images/nhl_bar.png",
        "choices": {
        "Your massive Canadian flag cape and a homemade jersey": [5, ["Alberta"]],
        "A small wooden moose for good luck": [5, ["Manitoba", "Yukon"]],
        "Just yourself and quiet optimism. You've been hurt before.": [5, ["Ontario"]],
        "A flask of maple syrup. You know you'll need it.": [5, ["Quebec", "Nova Scotia"]]
        }
    },
    "5": {
        "text": "Who are you rooting for in the Finals?",
        "image": "canada_images/finals_teams.png",
        "choices": {
        "The team that always gives you hope... then breaks your heart": [6, ["Ontario"]],
        "The team that’s actually in the finals": [6, ["Alberta", "Manitoba"]],
        "The American team that’s all Canadian players anyway": [6, ["British Columbia"]],
        "The team that says sorry when they score": [6, ["Prince Edward Island", "Nunavut", "New Brunswick", "Nova Scotia", "Newfoundland and Labrador"]]
        }
    },
    "6": {
        "text": "The Oilers lose in overtime. How do you drown your sorrows?",
        "image": "canada_images/oilers_loss.png",
        "choices": {
        "Sing dramatic karaoke with your friends": [7, ["Quebec", "Ontario"]],
        "Watch Anne of Green Gables and weep silently": [7, ["Prince Edward Island", "British Columbia"]],
        "Doomscroll and tweet “this is why we can’t have nice things”": [7, ["Alberta"]],
        "Eat your entire emergency freezer stash of Timbits": [7, ["Saskatchewan", "Newfoundland"]]
        }
    },
    "7": {
        "text": "You're walking home when a dark figure blocks your path. A mysterious being challenges you to a duel. What animal do you summon to fight alongside you?",
        "image": "canada_images/shadow_duel.png",
        "choices": {
        "Moose — tall, majestic, and weirdly fast": [8, ["Ontario", "New Brunswick"]],
        "Polar bear — nature's snow tank": [8, ["Manitoba", "Nunavut"]],
        "Canadian goose — wrathful and already angry": [8, ["Quebec", "British Columbia"]],
        "Beaver — small but surprisingly strategic": [8, ["Alberta", "Prince Edward Island"]]
        }
    },
    "8": {
        "text": "What’s your battle strategy?",
        "image": "canada_images/battle_strategy.png",
        "choices": {
        "Kill them with kindness (and maple syrup)": [9, ["Nova Scotia", "Prince Edward Island"]],
        "Let them win but smugly mention how our beer is better": [9, ["British Columbia", "Ontario"]],
        "Body check them into the next province": [9, ["Alberta", "Quebec"]],
        "Take the fight outside and wait until they freeze": [9, ["Yukon", "Northwest Territories"]]
        }
    },
    "9": {
        "text": "Victory! The mysterious being is defeated. They vanish into a puff of snow. What’s your next move?",
        "image": "canada_images/victory.png",
        "choices": {
        "Celebrate with a Tim Hortons run": [10, ["Saskatchewan"]],
        "Hop on a snowmobile and disappear into the night": [10, ["Yukon"]],
        "Reflect on what it means to be Canadian": [10, ["Ontario", "Nova Scotia"]],
        "Text your group chat: “You wouldn’t believe what just happened”": [10, ["British Columbia", "Manitoba"]]
        }
    }
...
const provincePersonalities = {
    "Onion": "Quebec",
    "Broccoli": "Nova Scotia",
    "Garlic": "Northwest Territories",
    "Jalapeno": "Alberta",
    "Tomato": "Ontario",
    "Green Bean": "Prince Edward Island",
    "Pumpkin": "Newfoundland & Labrador",
    "Carrot": "New Brunswick",
    "Potato": "Saskatchewan",
    "Napa Cabbage": "Manitoba",
    "Bok Choy": "British Columbia",
    "Leek": "Yukon"
};
...
let personalities = {};
for (let veggie in provincePersonalities) {
    personalities[veggie] = 0;
}
